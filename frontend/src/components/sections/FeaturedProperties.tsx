...
type Tab = "all" | PropertyCategory;

type FeaturedPropertiesProps = {
    compact?: boolean;
};

export default function FeaturedProperties({ compact = false }: FeaturedPropertiesProps) {
    ...
    const handleScroll = () => {
        if (scrollRef.current) {
            ...
            setCurrentIndex(Math.min(index, displayProperties.length - 1));
        }
    };
                    ...
                    <>
                                ...
                                <AnimatePresence mode="popLayout">
                                    {displayProperties.map((p) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <PropertyCard {...p} images={images} location={location} price={p.base_price} rating={p.avg_rating} />
                                            </motion.div>
                                        );
                                    })}
                                </AnimatePresence>
                        ...
                        <div className="mt-12 flex flex-col items-center gap-8">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                >
                                    View All {activeTab === "all" ? "Properties" : activeTab}
                                </Button>
